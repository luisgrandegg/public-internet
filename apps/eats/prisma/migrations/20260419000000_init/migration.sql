...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'ACCEPTED', 'PREPARING', 'READY_FOR_PICKUP', 'IN_DELIVERY', 'DELIVERED', 'CANCELLED');
...
CREATE TABLE "Order" (
    ...
    "restaurantId" TEXT NOT NULL,
    "itemsCost" INTEGER NOT NULL,
    "infrastructureFee" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "Delivery" (
    ...
    "distancePay" INTEGER NOT NULL DEFAULT 0,
