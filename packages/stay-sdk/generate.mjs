 ...
 *
 * Default input: ../../apps/stay/src/lib/openapi.json
...
const specPath = process.argv[2]
  ?? resolve(__dirname, '../../apps/stay/src/lib/openapi.json')
...
function generateSdkClass(resourceMap) {
  ...
  lines.push(...imports)
  lines.push('')
  lines.push('export class StaySDK {')
...
indexLines.push("export { StaySDK } from './sdk.js'")
indexLines.push('')
